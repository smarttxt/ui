do
	local ui = game.CoreGui:FindFirstChild("BlackSky 2")
	if ui then
		ui:Destroy()
	end
end
...
setclipboard("https://discord.com/invite/xe6CZ5Jj3X")
		end)
...
local XD = Main:newpage()

XD:Label("Auto Farm Function")

XD:Toggle("Toggle",nil,function(vu)
_G.Toggle = vu
...
local lockfarm1 = XD:Toggle("Toggle Lock/UnLock",nil,function(vu)

end)

lockfarm1:lock()

XD:Slider("Slider",false,false,0,100,10,function(vu)

end)

XD:Button("Button",function()
print("Button")
end)

XD:TextBox("TextBox","Click",function(vu)
print(vu)
end)
...
XD:Label("Settings Auto Farm")

local SelectWeapon = XD:Drop("Select Weapon / Combat",false,Weapon,function(Value)
    SelectToolWeapon = Value
    SelectToolWeaponOld = Value
end)

XD:Button("Refresh Weapon / Combat",function()
	SelectWeapon:Clear()
	for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do  
		if v:IsA("Tool") then
