...
do local GUI = game.CoreGui:FindFirstChild("BlackSky 4");if GUI then GUI:Destroy();end;if _G.Color == nil then
...
local osfunc = {}
	...
	Logo.Image = "rbxassetid://10016728380"
...
local Hub1 = Instance.new("TextLabel")
	...
	BindButton.MouseButton1Click:Connect(function ()
		game.CoreGui:FindFirstChild("BlackSky 4").Enabled = not game.CoreGui:FindFirstChild("BlackSky 4").Enabled
		Open.Visible = true
	end)
...
function Label1func:Refresh(tochange)
    ...
    --------------------------------------------------------------------
    local Library = Update:Window("    BlackSky");
    --------------------------------------------------------------------
    local Main = Library:Tab("Main","rbxassetid://6026568198")

Main:Button("Notification",function()
...
Main:Toggle("Toggle",nil,function(vu)
_G.Toggle = vu
...
Main:Textbox("Textbox",nil,function(vu)
print(vu)
end)
...
local SelectWeapon = Main:Dropdown("Dropdown",Weapon,function(Value)
print(Value)
